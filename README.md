...
| StudyRooms                                           | Pomodor styled real-time focus chat rooms with rich customizability options | Go, Chi, Postgres, AWS SQS, Websockets, Goroutines, Grafana Docker              | [Details](https://github.com/sakydev/sakydev/blob/main/studyrooms.md)   |
...
| ImportDash                                           | A system to collect and dynamically process accident records from dozens of US states and organize data in a dashboard | Python, Flask                                                    | [Details](https://github.com/sakydev/sakydev/blob/main/importdash.md)   |
